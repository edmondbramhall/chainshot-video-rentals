...
//             return state.videos.filter(v => v.status.value === videoStatus.Pending.value);
//         },
//     },
//     actions: {
...
//                     }
//                 });
//                 const txCount = await provider.getTransactionCount(context.state.connectedAccount);
